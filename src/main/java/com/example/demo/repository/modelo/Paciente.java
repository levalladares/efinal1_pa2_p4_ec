...
public class Paciente {
	...
	@SequenceGenerator(name = "seq_paciente",sequenceName = "seq_paciente",allocationSize = 1)// el allocationSize de coincidir con el valor que pusimos en el incremento
	@Id
	@Column(name = "paci_id")
	private Integer id;
